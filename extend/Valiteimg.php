    ...
    public function setKeys($path)
    {
        ...
        foreach($files as $file){
            ...
            foreach($this->dealData as $key => $value)
            {
                ...
                $this->Keys[$data]=$name[$key]   ;        
            }
            }
        }
       writefile('','keys',serialize($this->Keys));
    }
...
//					echo " ";
	...
	{
		$this->Keys = unserialize(file_get_contents('keys'));
