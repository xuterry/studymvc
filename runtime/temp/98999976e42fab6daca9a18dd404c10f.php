<?php if (!defined('CORE_PATH')) exit(); /*a:2:{s:48:"F:\zend\studymvc\app\test\view\test\monitor.html";i:1539696261;s:47:"F:\zend\studymvc\app\test\view\test\header.html";i:1533967749;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
...
<dvi class='info'><?php if(is_array($test) || $test instanceof \think\Collection || $test instanceof \think\Paginator): $i = 0; $__LIST__ = $test;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><span><?php echo $a['v']; ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<!DOCTYPE html>
<html lang="zh">
