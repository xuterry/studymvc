...
App({
  d: {
    appId:"wxa07c1568ef4d9200", // 小程序appid
    appKey:"bdbb6acf0c24d89a281eba0efe4ccf2b", // 小程序密钥
    purchase: 0,//设置购物车刷新
    ...
    h_color:'#FF63477',
    order:{},
    ceshiUrl: 'http://t.cctvlian.cn/api',
  },
  ...
  userlogin: function (page) {
    ...
    if (this.globalData.userInfo.nickName == ''|| !this.globalData.userInfo.nickName || this.globalData.userInfo.openid == '' || !this.globalData.userInfo.openid) {
      if (page) {
        wx.navigateTo({
          url: '../login/login'
        })
