...
Page({
  ...
  AddressManagement: function () {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/address/up_addsindex',
      data: {
  ...
  AddressManagement1: function () {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/user/AddressManagement',
      data: {
        openid: app.globalData.userInfo.openid,
      },
      method: "POST",
  ...
  getCityArr: function (count) {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/user/getCityArr',
      data: {
        count: count,
      },
      method: "POST",
  ...
  getCountyInfo: function (count, column) {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/user/getCountyInfo',
      data: {
        count: count,
        column: column,
      },
  ...
  Preservation: function (rew) {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/user/Preservation',
      data: {
        sheng: rew[0],
        shi: rew[1],
        xuan: rew[2]
  ...
  SaveAddress: function (e) {
    ...
    if (e.detail.value.user_name.length == 0) {
      ...
      wx.request({
        url: app.d.ceshiUrl + '/address/up_adds',
        data: {
          openid: app.globalData.userInfo.openid,
