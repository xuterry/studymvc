...
bindMinus: function(e) {
    ...
    if(num < 1){
      ...
      wx.request({
        url: app.d.ceshiUrl + '/product/up_cart',
        method:'post',
        data: {
...
delall: function () {
  ...
  wx.showModal({
    ...
    success: function (res) {
      if (res.confirm){
            wx.request({
              url: app.d.ceshiUrl + '/product/delAll_cart',
              method: 'post',
              data: {
                user_id: that.data.user_id,
              },
...
shouc: function () {
  ...
  //ajax请求
  wx.request({
    url: app.d.ceshiUrl + '/product/to_Collection',
    method: 'post',
    data: {
      user_id: that.data.user_id,
      carts: toastStr,
...
onShow: function () {
    ...
    wx.showModal({
      ...
      success: function(res) {
        res.confirm && wx.request({
          url: app.d.ceshiUrl + '/product/delcart',
          method:'post',
          data: {
            carts: carts,
          },
  ...
  loadProductData:function(){
    var that = this;
      wx.request({
        url: app.d.ceshiUrl + '/product/Shopping',
        method: 'post',
        data: {
          user_id: app.globalData.userInfo.openid
        },
