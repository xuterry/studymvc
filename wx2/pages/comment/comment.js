...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: app.d.ceshiUrl + '/product/comment',
      method: 'post',
      data: {
  ...
  saveimg: function (id,key) {
    ...
    for (var i = 0, len = images.length; i < len; i++) {
      that.upload_file('/product/t_comment&type=file', images[i], 'imgFile', formData);
    }
  },
  submitComment: function (e) {
    ...
    wx.request({
      url: app.d.ceshiUrl + '/product/t_comment&type=json',
      method: 'post',
      data: {
