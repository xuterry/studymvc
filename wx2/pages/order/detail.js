...
Page({
  ...
  sendFormid: function (fromid, page) {
	...
	loadProductDetail: function() {
		...
		wx.request({
			url: app.d.ceshiUrl + '/order/order_details',
			method: 'post',
			data: {
		...
		wx.showModal({
			...
			success: function(res) {
				res.confirm && wx.request({
					url: app.d.ceshiUrl + '/order/removeOrder',
					method: 'post',
					data: {
	...
	recOrder: function(e) {
		...
		wx.showModal({
			...
			success: function(res) {
				res.confirm && wx.request({
					url: app.d.ceshiUrl + '/order/recOrder',
					method: 'post',
					data: {
						id: orderId,
					},
