...
Page({
  ...
  addShopart: function (e, sizeid) { 
    //添加到购物车
    var that = this;
    var pro_type = e.target.dataset.type;
    if (pro_type != 'canjiapintuan') {
      wx.request({
        url: app.d.ceshiUrl + '/product/add_cart',
        method: 'post',
        data: {
  ...
  addFavorites: function (e) {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/addFavorites/index',
      method: 'post',
      data: {
  ...
  delFavorites: function (e) {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/addFavorites/removeFavorites',
      method: 'post',
      data: {
